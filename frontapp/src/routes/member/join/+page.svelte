...
<div class="flex-col">
    <div class="items-center">Join</div>
    {#if errorMsg !== ''}
    ...
    {/if}
    <form class="p-5" on:submit|preventDefault={fetchJoin}>
        ...
        <input bind:value={passwordconfirm} id="passwordconfirm" type="text" placeholder="Passwordconfirm" class="input input-bordered input-sm w-full max-w-xs" />
